...
const CoursesManagement = React.lazy(() =>
  import("../Pages/Auth/CoursesManagement.jsx").catch(() => ({
    default: () => <FailedToLoadCoursesPage />,
  }))
);

// Knowledge module (lazy)
const FailedToLoadKnowledgePage = () => <div style={{ padding: 12 }}>Failed to load Knowledge page</div>;
const KnowledgeManagement = React.lazy(() =>
  import("../Pages/Auth/KnowledgeBaseManagement.jsx").catch(() => ({
    default: () => <FailedToLoadKnowledgePage />,
  }))
);

// New: Analytics module (lazy)
const FailedToLoadAnalyticsPage = () => <div style={{ padding: 12 }}>Failed to load Analytics page</div>;
...
const FailedToLoadUsersPage = () => <div style={{ padding: 12 }}>Failed to load Users page</div>;
const FailedToLoadChassisDoctorPage = () => <div style={{ padding: 12 }}>Failed to load Chassis Doctor page</div>;
const FailedToLoadCoursesPage = () => <div style={{ padding: 12 }}>Failed to load Courses page</div>;
const FailedToLoadLiveEventsPage = () => <div style={{ padding: 12 }}>Failed to load Live Events page</div>;
...
const ErrorPage = ({ error }) => {
  return (
    <div className="p-8 text-center" style={{ color: "inherit" }}>
      ...
      <p style={{ marginBottom: 16 }}>The page you're looking for doesn't exist or couldn't be loaded.</p>
      <div>
        <a
          href="/"
          className="px-4 py-2 rounded-xl border inline-block"
          style={{ borderColor: "#444", backgroundColor: "#111", color: "#fff" }}
        >
          Go back home
        </a>
      </div>
